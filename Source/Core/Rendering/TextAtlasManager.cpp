...
static void UTextAtlasManager::SetAtlasManager(int InWidth, int InHeight, int InColumns, int InRows, int InMarginX, int InMarginY)
{
...
static void UTextAtlasManager::SetAtlasSize(int InWidth, int InHeight)
{
	AtlasWidth = InWidth;
	AtlasHeight = InHeight;
}

static void UTextAtlasManager::SetGridLayout(int InColumns, int InRows)
{
	Columns = InColumns;
	Rows = InRows;
}

static void UTextAtlasManager::SetMargin(int InMarginX, int InMarginY)
{
	MarginX = InMarginX;
	MarginY = InMarginY;
}

FVector4 UTextAtlasManager::GetCharUV(char character) const
{
    ...
    rect.X = static_cast<float>(cellWidth);
    rect.Y = static_cast<float>(cellHeight);
    rect.Z = static_cast<float>(x) / AtlasWidth;
    rect.W = static_cast<float>(y) / AtlasHeight;
